...
#
# ---------------------------------------------------------------------
# Function record_audio(float)
# ---------------------------------------------------------------------
# This function will take in a float as input. Given a sampling rate
# of 44100 [Hz] (This prevents aliasing when sampling the recorded
# signal, this function will record for a given duration, finally
# writing this audio recording to a wav file that will save into the
# 'match' directory of this project.
#
#######################################################################
def record_audio(duration):
    ...
    sd.wait()
    wavfile.write(recording_file, fs, audio)

# Recording file and directory path for the pre-defined sounds.
recording_file = 'recording_test'
